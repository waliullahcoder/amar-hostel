                ...
                <div class="row mb_30">
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="frontend/images/room1.jpg" alt="" fetchpriority="high" decoding="sync">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="frontend/images/room2.jpg" alt="" loading="lazy" decoding="async">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="frontend/images/room3.jpg" alt="" loading="lazy" decoding="async">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="frontend/images/room4.jpg" alt="" loading="lazy" decoding="async">
                                <a href="#" class="btn theme_btn button_hover">Book Now</a>
                            </div>
        ...
        <section class="about_history_area section_gap">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img class="img-fluid" src="frontend/images/about_bg.jpg" alt="img" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="testimonial_slider owl-carousel">
                    <div class="media testimonial_item">
                        <img class="rounded-circle" src="frontend/images/testtimonial-1.jpg" alt="" loading="lazy" decoding="async">
                ...
                <div class="row mb_30">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="frontend/images/blog-1.jpg" alt="post" loading="lazy" decoding="async">
                            </div>
                            <div class="details">
                                <div class="tags">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="frontend/images/blog-2.jpg" alt="post" loading="lazy" decoding="async">
                            </div>
                            <div class="details">
                                <div class="tags">
                                    <a href="#" class="button_hover tag_btn">Travel</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="img-fluid" src="frontend/images/blog-3.jpg" alt="post" loading="lazy" decoding="async">
                            </div>
                            <div class="details">
                                <div class="tags">
                                    <a href="#" class="button_hover tag_btn">Travel</a>
