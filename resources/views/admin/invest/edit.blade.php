    ...
    <div class="row g-3">
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <select name="calculate" id="calculate" class="form-select select" data-placeholder="Select Type" required>
                <option value="1" {{ $data->calculate == '1' ? 'selected' : '' }}>Calculate</option>
                <option value="0" {{ $data->calculate == '0' ? 'selected' : '' }}>Not Calculate</option>
            </select>
        </div>
        <div class="col-md-4 col-sm-6">
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <input type="number" class="form-control" id="amount" name="amount" value="{{ $data->amount }}"
                placeholder="Invest Amount" required>
        </div>
        <div class="col-md-4 col-sm-6">
